...
If `BUGS.md` has an entry but `bugs/BUG-ID.md` is missing, keep the index row, report `needs-info`, and ask for recovery context or route to `/107-sg-test --retest BUG-ID`.
