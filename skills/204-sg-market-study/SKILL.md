...
- FOLLOW-UP: route implementation, content, product, or GTM decisions to `/100-sg-spec` when findings cross chantier threshold.
...
- `rg -n "Trace category|Process role|Chantier Potential|demand|competition|monetization|GO / NO-GO|references/" skills/204-sg-market-study/SKILL.md`
