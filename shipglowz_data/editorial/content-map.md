...
|---|---|
| New official artifact | `README.md`, `shipglowz_data/workflow/playbooks/spec-driven-workflow.md`, `tools/shipglowz_metadata_lint.py`, `skills/references/canonical-paths.md`, `skills/sg-docs/SKILL.md`, `site/src/pages/docs.astro`, `site/src/components/RoleMap.astro` |
