...
- Update `shipglowz-site/src/content/skills/sg-technical.md` if `010-sg-technical deps` gains explicit CVE/KEV/exposure/action-priority language beyond current dependency audit wording.
...
- [ ] Task 7: Update user-facing help/docs where promises changed.
  - File: `skills/sg-veille/README.md`, `shipglowz-site/src/content/skills/sg-technical.md`, `skills/sg-check/README.md`, `skills/sg-help/references/help-catalog.md`, optional public skill pages if found.
  ...
  - Validate with: `rg -n "vendor-risk|CVE|KEV|security signal|sg-maintain security|010-sg-technical deps" skills/sg-veille/README.md shipglowz-site/src/content/skills/sg-technical.md skills/sg-check/README.md skills/sg-help/references/help-catalog.md`
