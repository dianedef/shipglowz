...
🟠 [ShipGlowz] task: Empêcher les scans DevServer de descendre dans le contenu des répertoires `.flox` et rendre la synchronisation du registre lazy ou stale-aware | status: todo | area: runtime-cli-perf | id: devserver-startup-flox-prune | spec: shipglowz_data/workflow/specs/devserver-ui-centralization.md | evidence: démarrage 3.45s; scan actuel 2.59s; scan avec prune 0.05s | next: /102-sg-start Centraliser le design system du shell DevServer et réduire la latence des sélecteurs
🟠 [ShipGlowz] task: Réutiliser le registre ou un cache persistant pour les listes d'environnements et supprimer le second scan perdu dans un sous-shell | status: todo | area: runtime-cli-perf | id: devserver-environment-cache | spec: shipglowz_data/workflow/specs/devserver-ui-centralization.md | evidence: raccourci m r atteint le picker en 6.68s | next: /102-sg-start Centraliser le design system du shell DevServer et réduire la latence des sélecteurs
🟡 [ShipGlowz] task: Mesurer puis borner le quiet drain TTY pour les raccourcis directs sans réintroduire de fuite de touches | status: todo | area: runtime-cli-perf | id: devserver-tty-drain | spec: shipglowz_data/workflow/specs/devserver-ui-centralization.md | evidence: délai plancher intentionnel de 120ms avant les filtres interactifs | next: /102-sg-start Centraliser le design system du shell DevServer et réduire la latence des sélecteurs
