...
- Project root Markdown is intentionally narrow. `README.md`, `AGENT.md`, `AGENTS.md` as a compatibility symlink, optional `CLAUDE.md`, and optional public `CHANGELOG.md` may stay at the root. ShipGlowz governance artifacts such as business, product, brand, GTM, content map, context, architecture, guidelines, specs, bugs, research, reviews, audits, and verification reports belong under `shipglowz_data/`.
