...
| `skills/references/design-inspiration-library.md`, `skills/references/design-inspiration/**`, `tools/capture_design_inspiration.py`, `tools/capture_design_inspiration_playwright.js`, `tools/test_capture_design_inspiration.py`, `tools/fixtures/design-inspiration/**` | Private design inspiration library | `shipglowz_data/technical/skill-runtime-and-lifecycle.md` | `README.md`, `skills/references/private-data-repo-contract.md` | `python3 -m unittest tools.test_capture_design_inspiration`; `node --check tools/capture_design_inspiration_playwright.js`; synthetic `--fixture --no-network` capture into a temporary directory; shared-runtime local HTTP smoke; metadata lint; targeted Inspiration Gate `rg` checks | Private/public storage boundary, shared Playwright runtime discovery, capture bundle/schema, extraction, browser/image pipeline, checksums/dedupe, rights status, or design/copy skill consumption changes |
