---
name: shipglowz
description: Route ShipGlowz workflows, packs, and packaging audits in OpenCode.
argument-hint: "<instruction | help | packs | audit packaging>"
---

# ShipGlowz for OpenCode

Use this skill when working in the ShipGlowz repository with OpenCode.
